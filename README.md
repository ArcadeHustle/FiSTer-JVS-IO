...
Although we've not completely abandoned this path, we will be backburnering it for now as for focus on a USB based solution that fits more into the MiSTer landscape. 
